...
public class Menue extends State implements StateInterface {

	private MenueButton[] buttons = new MenueButton[3];
    ...
    private void loadButtons() {
        ...
        buttons[0] = new MenueButton(xPosition, 150 + offsetY, 0, GameState.PIONS_SELECTION);
        buttons[1] = new MenueButton(xPosition, 220 + offsetY, 1, GameState.OPTIONS);
        buttons[2] = new MenueButton(xPosition, 290 + offsetY, 2, GameState.QUIT);
    }
